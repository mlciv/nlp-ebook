...
!!! note "Tentative schedule"
    Lectures meet **Tuesday & Thursday, 1:30–2:45 pm** in **Sarkeys Energy Center
    A0236**. Dates, topics, and lecture grouping may shift during the semester;
    the authoritative deadlines are always those posted on Canvas. Assignments are
    **due at 12:00 pm (noon)** on the listed date.
...
!!! tip "Slides & notebooks"
    Lecture slides are posted on Canvas. The hands-on **notebook chapters** for each
    assignment are linked from the [Table of Contents](notebooks/index.md) and can be
    opened in Colab with one click.
