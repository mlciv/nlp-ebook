...
Some chapters incorporate or adapt openly licensed third-party materials (for example,
illustrations and code from other open resources). Such materials remain under their
original licenses; attributions and links are provided within the relevant chapters.
